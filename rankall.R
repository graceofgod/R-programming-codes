...
##The function reads the outcome-of-care-measures.csv ﬁle and returns a 2-column data frame containing the hospital 
#in each state that has the ranking speciﬁed in num.
